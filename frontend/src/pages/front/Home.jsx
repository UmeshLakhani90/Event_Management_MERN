          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <div className="block">
                  <h1 className="animated fadeInUp">A Digital Marketing <br />  &amp; Design Agency</h1>
                  <p className="animated fadeInUp">We love the Web and the work we do.We work closely with our clients to deliver <br />  the best possible solutions for their needs</p>
                  <a href="https://themefisher.com/free-bootstrap-templates/" className="btn btn-main animated fadeInUp">Free Bootstrap Templates</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row justify-content-end">
              <div className="col-md-6">
                ...
                <a href="portfolio.html" className="btn btn-view-works">View Works</a>
              </div>
            </div>
          </div>
        </section>
                  ...
                  <ul className="counter-box clearfix">
                    <li>
                      <div className="counter-item">
                        ...
                        <h4 className="count" data-count={99}>0</h4>
                    ...
                    <li>
                      <div className="counter-item">
                        ...
                        <h4 className="count" data-count={45}>0</h4>
                    ...
                    <li>
                      <div className="counter-item">
                        ...
                        <h4 className="count" data-count={125}>0</h4>
                    ...
                    <li>
                      <div className="counter-item">
                        ...
                        <h4 className="count" data-count={200}>0</h4>
